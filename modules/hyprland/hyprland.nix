...

{
	...
	wayland.windowManager.hyprland = {
		...
		decoration = {
		  ...
		  "$mod, B, exec, $browser"
		  "$mod SHIFT, S, exec, hyprshot -m region -o /home/user/Pictures/Screenshot/"
		  ",PRINT, exec, hyprshot -m output -o /home/user/Pictures/Screenshot/"
		  "$mod, J, togglesplit,"
		  "$mod, P, exec, $power"
		  "$mod, W, exec, /home/user/.nixos/modules/hyprland/scripts/switchwall.sh"
