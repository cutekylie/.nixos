...

{
	...
	wayland.windowManager.hyprland = {
		...
		cursor = {
		  ...
		  "ags run /home/user/.nixos/modules/main-pc/home/hyprland/rice/ags/ &"
		];
		...
		decoration = {
		  ...
		  "$mod, J, togglesplit,"
		  "$mod, P, exec, $power"
		  "$mod, W, exec, /home/user/.nixos/modules/main-pc/home/hyprland/scripts/switchwall.sh"
		...
		binde = [
		  ...
		  "float,class:^(gjs)$,title:^(Notifiche)$"
